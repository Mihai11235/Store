...
public:
	...
	void adauga_service(const int&, const string&, const string&, const string&, const double&);
	
	//Modifies a product from the store
	void modifica_service(const int&, const string&, const string&, const string&, const double&);
	
	//Deletes a product from the store by id
	void sterge_service(const int&);	
	
	//Searches a product from the store by id and returns it
	const Produs& cauta_service(const int&) const;
