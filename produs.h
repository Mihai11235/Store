...
public:
	...
	Produs() = delete;
	//Produs constructor
	Produs(const int& id, const string& nume, const string& tip, const string& producator, const double& pret) :id{ id },nume { nume }, tip{ tip }, producator{ producator }, pret{ pret } {};
